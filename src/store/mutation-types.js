...
export const UPDATE_NEW_FRIENDS = 'UPDATE_NEW_FRIENDS';//更新朋友列表
export const REMOVE_ACCOUNT = 'REMOVE_ACCOUNT';//本地清空某个帐号的所有信息
...
export const SAVE_SCROLL_POSITION = 'SAVE_SCROLL_POSITION';//保存滚动 位置
