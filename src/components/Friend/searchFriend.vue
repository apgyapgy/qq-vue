	...
	<div class="wrapper">
		<div class="search">
			<div class="search_input">
				<input type="text" class="text" placeholder="QQ号/手机号/群/公众号" v-model="search">
				<img src="./icon/cross.png" @click="clear" v-show="search!=''" alt="" class="clear">
			...
			<div class="search_result" v-show="hasSearch">
				...
				<VScroll :data="dataList" v-show="hasResult&&hasManyResult" component="searchFriend">
					<ul>
						<li v-for="item in dataList" @click="$router.push(`/profile/${item.id}`)"></li>
