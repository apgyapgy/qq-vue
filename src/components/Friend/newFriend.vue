				...
				<ul>
					<li v-for="item in dataList">
						<template v-if="item.to_user==userId">
							<img :src="item.face" alt="" class="user">
							<div class="info">
								<div @click="gotoApply(item.id)">
									...
									<button class="agree" v-if="item.status==1" @click.stop="agree(item.id)">同意</button>
						...
						<template v-else-if="item.status==3">
							<img :src="item.face" class="user" alt="">
							<div class="info">
								<div>
									<p class="name mes">{{item.nick_name}}</p>
									<p class="message">{{item.info}}</p>
...
<script>
	...
	export default{
		...
		data(){
			return{
				dataList:[{"id":7,"to_user":1,"source":"QQ群-心理电影周日8-9W7306","apply_message":"请求加为好友","status":2,"time":1500023000,"face":"/static/user/face/11.jpg","nick_name":"斜阳云云美","age":20,"sex":"男"},{"id":5,"to_user":6,"status":1,"time":1500022150,"face":"/static/user/face/8.jpg","nick_name":"缥缈孤鸿影","info":"已发送验证消息"},{"id":4,"to_user":1,"source":"临时会话","apply_message":"你是诸葛亮?","status":2,"time":1500022140,"face":"/static/user/face/7.jpg","nick_name":"心有芊芊结","age":21,"sex":"女"},{"id":3,"to_user":1,"source":"QQ群-牛客网IT笔试面试交流群","apply_message":"向大神学习","status":2,"time":1500022130,"face":"/static/user/face/6.jpg","nick_name":"云端之上","age":20,"sex":"男"},{"id":2,"to_user":1,"source":"QQ号查找","apply_message":"大哥,想请教一个问题","status":2,"time":1500022120,"face":"/static/user/face/5.jpg","nick_name":"一花一世界","age":0,"sex":"男"},{"id":1,"to_user":1,"source":"QQ群-ThinkPHP技术交流中心","apply_message":"大哥,想请教一个问题","status":2,"time":1500022110,"face":"/static/user/face/4.jpg","nick_name":"浅唱低吟","age":19,"sex":"女"},{"id":6,"to_user":1,"source":"QQ号查找","apply_message":"请求加为好友","status":2,"time":1500020000,"face":"/static/user/face/9.jpg","nick_name":"古今如梦","age":19,"sex":"女"}],
					hasGetNewFriends:1
			}
		},
		computed:{
