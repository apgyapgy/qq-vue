<template>
	...
	<div class="wrapper">
		...
		<div class="searchbox">
			<input type="text" class="text" readonly placeholder="QQ号/手机号/群/公众号" @click="$(router.push('/friend/add/search'))">
		</div>
		<!-- 找人 -->
		...
		<div class="offical" v-show="curTab==3">
			...
			<ul>
				<li>
					<img :src="curTab==3?'./icon/qol.png':''" class="user" alt="">
					<div class="info">
						<p class="name">QQ音乐</p>
				...
				<li>
					<img :src="curTab==3?'./icon/phb.png':''" alt="" class="user">
					<div class="info">
						<p class="name">QQ团队</p>
						<p class="intro">QQ团队所有成员感谢您的一路相伴</p>
					</div>
				</li>
				<li>
					<img :src="curTab==3?'./icon/rfc.png':''" alt="" class="user">
					<div class="info">
						<p class="name">好友动态</p>
						<p class="intro">好友动态为您每日推送QQ空间好友未读动态请求</p>
					</div>
				</li>
			</ul>
		</div>
