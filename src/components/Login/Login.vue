<template>
	...
	<div class="wrapper">
		...
		<div class="login">
			<div class="top">
				<img src="/rpk.png"><span>QQ</span>
			</div>
			<div class="form">
				<input type="text" name="" v-model="userinfo.user" class="text" placeholder="QQ号/手机号/邮箱" ref="user"><br/>
				<input type="password" name="" v-model="userinfo.pwd" class="text" placeholder="密码"><br/>
				<input type="button" @click="login" name="" class="btn" value="登录">
