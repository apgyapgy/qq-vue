<template>
	...
	<div class="wrapper">
		...
		<div class="login">
			...
			<div class="form">
				<input type="text" v-model="userinfo.user" class="text" placeholder="QQ号/手机号/邮箱" name="" ref="user"><br/>
				<input type="password" v-model="userinfo.pwd" class="text" placeholder="密码" name=""><br/>
				<input type="button" @click="login" class="btn" value="登录" name="">
