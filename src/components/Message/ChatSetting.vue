		...
		<div class="chatSetting">
			<ul>
				<li @click="$router.push(`/profile/${dataList.other_user_id}`)">
					<img :src="dataList.face" class="user" alt="">
					<div class="info">
						...
						<img src="./icon/nqj.9.png" class="icon" alt="">
					</div>
				</li>
			</ul>
			<div class="setting">
	...
	export default{
		...
		methods:{
			async getUserInfo(userId,otherUserId){
				...
				const data = {"user_id":1,"other_user_id":2,"is_pingbi":0,"face":"/static/user/face/4.jpg","sex":"女","age":19,"place":"江西","special":1,"beizhu":"楚乔"};
				this.dataList = data;
