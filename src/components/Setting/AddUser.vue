<template>
	...
	<div class="wrapper">
		...
		<div class="header">
			<div class="item"></div>
			<div class="item center">添加或注册帐号</div>
			<div class="item right" @click="$router.back()">取消</div>
		</div>
		<div class="addUser">
			<form>
				<input type="text" class="text" placeholder="QQ号/手机号/邮箱" v-model="userinfo.user">
				<input type="password" class="text" placeholder="密码" v-model="userinfo.pwd">
